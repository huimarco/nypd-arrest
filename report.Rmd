...
ggplot(aes(x=yearmonth,y=count,group=1)) + 
  ...
  labs(title='Number of Arrests (Jan 2018 - Jun 2022)') +
  gg_theme +
...
A challenge that I forsee would be the large number of possible output classifications. Although OFNS_DESC has fewer unique values than PD_DESC, there is still a decent amount. To make a more generalisable model, I would probably have to look through the possible types and consolidate some. 
